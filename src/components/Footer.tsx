        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-center sm:text-left">
          ...
          <div className="col-span-1 sm:col-span-2">
            ...
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 max-w-sm mx-auto sm:mx-0">
              Forging your career path with industry-leading resume optimization and intelligent job matching.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li>
                <a href="mailto:support@resumecraft.com" className="text-sm sm:text-base text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center group">
