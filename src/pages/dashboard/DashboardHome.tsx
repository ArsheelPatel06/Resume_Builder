    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setStatsData([
          {
            ...
            trend: "+0%", // We don't track historical yet
            trendUp: true,
            description: "Average resume quality",
            icon: <LineChart className="h-5 w-5 text-blue-500" />,
            color: "from-blue-500 to-indigo-600"
          },
          {
            title: "Simulated Match",
            value: "75", // Mock until we implement Job Match fully
            trend: "+2%",
            trendUp: true,
            description: "Est. match rate",
        ...
        setStatsData([
          ...
          // ... keep other minimal fallbacks or just empty
          {
      ...
      try {
        ...
        const response = await apiClient.get<ActivityData[]>('/dashboard/recent');
